      ...
      switch (index) {
        ...
        default:
          if (modelo.produtosNoCarrinho.length > indiceProduto) {
            return ItemCarrinho(
              indice: index,
              produto: modelo.obtemProdutoPorCodigo(
                  modelo.produtosNoCarrinho.keys.toList()[indiceProduto]),
              quantidade:
                  modelo.produtosNoCarrinho.values.toList()[indiceProduto],
              ultimoItem: indiceProduto == modelo.produtosNoCarrinho.length - 1,
              formatador: _formatoMoeda,
            );
          } else if (modelo.produtosNoCarrinho.keys.length == indiceProduto &&
              modelo.produtosNoCarrinho.isNotEmpty) {
            return Padding(
